...
import com.example.textquest.databinding.FragmentEndHomeBinding
...
import com.example.textquest.databinding.FragmentHappyEndBinding
...
class HappyEnd : Fragment() {

    lateinit var binding: FragmentHappyEndBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentHappyEndBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button2.setOnClickListener{
            MAIN.navController.navigate(R.id.action_happyEnd_to_screenFragment)

        }
        binding.button3.setOnClickListener{
            MAIN.navController.navigate(R.id.action_happyEnd_to_menuOneFragment)
