...
class EndShip : Fragment() {

    lateinit var binding: FragmentEndShipBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentEndShipBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            MAIN.navController.navigate(R.id.action_endShip_to_badEnd)
