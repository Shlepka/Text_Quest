...
import com.example.textquest.databinding.FragmentTestSevBinding


class TestSev : Fragment() {

    lateinit var binding: FragmentTestSevBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding= FragmentTestSevBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
