...
import com.example.textquest.databinding.FragmentHelpFourBinding
...
class HelpFour : Fragment() {

    lateinit var binding: FragmentHelpFourBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding= FragmentHelpFourBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding.button.setOnClickListener{
            MAIN.navController.navigate(R.id.action_helpFour_to_helpFive)

        }
        binding.button2.setOnClickListener{
            MAIN.navController.navigate(R.id.action_helpFour_to_endHome)
